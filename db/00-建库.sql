CREATE DATABASE [crud] ON  PRIMARY 
( NAME = N'crud', FILENAME = N'C:\Program Files (x86)\Microsoft SQL Server\MSSQL10_50.MSSQLSERVER\MSSQL\DATA\crud.mdf' , SIZE = 3072KB , FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'crud_log', FILENAME = N'C:\Program Files (x86)\Microsoft SQL Server\MSSQL10_50.MSSQLSERVER\MSSQL\DATA\crud_log.ldf' , SIZE = 1024KB , FILEGROWTH = 10%)
GO
ALTER DATABASE [crud] SET COMPATIBILITY_LEVEL = 100
GO
...
GO
ALTER DATABASE [crud] SET AUTO_CREATE_STATISTICS ON 
GO
...
USE [crud]
GO
IF NOT EXISTS (SELECT name FROM sys.filegroups WHERE is_default=1 AND name = N'PRIMARY') ALTER DATABASE [crud] MODIFY FILEGROUP [PRIMARY] DEFAULT
GO
